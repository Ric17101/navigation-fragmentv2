...
public class FinestWebViewActivity extends AppCompatActivity
  ...
  protected void initializeOptions() {
    ...
    if (builder.webViewHttpAuthEnabled && !builder.authKeyAccess.equals("")) {
      this.authAccess = builder.authKeyAccess;
    }
    ...
    { // WebView
      ...
      if (!this.authAccess.equals("")) {
        ...
        // webView.loadUrl(this.url, auth);
         //webView.setHttpAuthUsernamePassword(this.url, "Protected", this.authAccess.split(":")[0], this.authAccess.split(":")[1]);
        webView.getSettings().setDomStorageEnabled(true);
        webView.setWebViewClient(new WebViewClient(){
          @Override
          public boolean shouldOverrideUrlLoading(WebView view, String url) {
            view.loadUrl(url, auth);
            return true;
          }
          @Override
          public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            if (errorCode == 401) {
              ...
              Log.e("onReceivedError", description + "failingUrl= " + failingUrl +" errorCode=" +errorCode);
            }
          }
//          @Override
...
//          }
  ...
  public class MyWebViewClient extends WebViewClient {
    ...
    /**
     * Fuck this library,,, It worked for HTTP Authentication with this Override!!!!
     * @param view
     * @param handler
     * @param host
     * @param realm
    ...
    public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host, String realm) {
      ...
      if (!authAccess.equals("")) {
        String encoding = Base64.encodeToString(authAccess.getBytes(), Base64.DEFAULT);
        final Map<String, String> auth = new HashMap<String, String>();
        auth.put("Authorization", "Basic " + encoding);
        view.loadUrl(url, auth);
      }
