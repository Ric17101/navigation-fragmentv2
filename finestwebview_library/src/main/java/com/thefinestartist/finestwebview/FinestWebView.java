...
public class FinestWebView {
  ...
  public static class Builder implements Serializable {
    ...
    protected String authKeyAccess;
    protected Boolean webViewHttpAuthEnabled = false;
    ...
    public Builder webViewHttpAuth(boolean webViewHttpAuthEnable) {
      this.webViewHttpAuthEnabled = webViewHttpAuthEnable;
      return this;
    }

    public Builder setHttpAuthKey(String authAccess) {
      this.authKeyAccess = authAccess;
      return this;
    }
    ...
    protected void show(String url, String data) {
      ...
      if (webViewHttpAuthEnabled) {
        intent.putExtra("auth_access", this.authKeyAccess);
      }
