      ...
      switch(rotation){
       /* case Surface.ROTATION_0:
        ...
        case Surface.ROTATION_0:
          ...
          leftOffset = (screenResolution.y - width) / 5;
          topOffset = (screenResolution.x - height) * 2 / 3;
          framingRect = new Rect(leftOffset, topOffset, screenResolution.y - leftOffset, topOffset + height * 5 / 7);
          Log.e(TAG, framingRect.toString() +"\n" +
                  leftOffset+ "\n" +
                  topOffset+ "\n" +
                  (screenResolution.y - leftOffset )+ "\n" +
                  topOffset + height * 4 / 7);
          break;
      default: 
