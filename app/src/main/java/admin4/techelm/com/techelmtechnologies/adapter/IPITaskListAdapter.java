...
public class IPITaskListAdapter extends RecyclerView.Adapter<IPITaskListAdapter.ViewHolder> {

    private static final String LOG_TAG = IPITaskListAdapter.class.getSimpleName();
    ...
    public IPITaskListAdapter(Context context) {
        mContext = context;
    ...
    public IPITaskListAdapter(List<ServiceJobWrapper> serviceJobList) {
