...
public class IPI_PWCActionDBUtil extends DatabaseAccess {

    private static final String LOG_TAG = "RecordingSJDBUtil";

    public static abstract class DBHelperItem implements BaseColumns {
        public static final String TABLE_NAME = "projectjob_ipi_pw_corrective_actions";
        public static final String COLUMN_NAME_RECORDING_ID = "id";
        public static final String COLUMN_NAME_RECORDING_SERVICE_ID = "projectjob_ipi_pw_id";
        public static final String COLUMN_NAME_RECORDING_NAME = "serial_no";
        public static final String COLUMN_NAME_RECORDING_FILE_PATH = "car_no";
        public static final String COLUMN_NAME_RECORDING_LENGTH = "description";
        public static final String COLUMN_NAME_RECORDING_TIME_ADDED = "target_remedy_date";
        public static final String COLUMN_NAME_RECORDING_TAKEN = "completion_date";
        public static final String COLUMN_NAME_RECORDING_TAKEN_ = "remarks";
        public static final String COLUMN_NAME_RECORDING_TAKEN__ = "disposition";
    }
    ...
    public interface OnDatabaseChangedListener {
        void onNewIPI_PWTaskEntryAdded(String fileName);
        void onIPI_PWTaskEntryRenamed(String fileName);
        void onIPI_PWTaskEntryDeleted();
    }
    /**
     * Private constructor to avoid object creation from outside classes.
     * @param context
     */
    public IPI_PWCActionDBUtil(Context context) {
        super(context);
        try {
     ...
     */
    public IPI_PWCActionDBUtil(Context context, String message) {
        super(context);
    ...
    public void removeItemWithId(int id) {
        ...
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onIPI_PWTaskEntryDeleted();
        }
    ...
    public int addRecording(String recordingName, String filePath, long length, int serviceId, String taken) {
        ...
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onNewIPI_PWTaskEntryAdded(recordingName);
        }
        return rowId;
    }
    ...
    public void renameItem(IPI_CActionWrapper_NOT_USED item, String recordingName, String filePath) {
        ...
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onIPI_PWTaskEntryRenamed(item.getCarNo());
        }
    }
