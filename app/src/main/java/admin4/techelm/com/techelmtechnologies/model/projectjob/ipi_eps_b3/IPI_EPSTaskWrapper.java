...
public class IPI_EPSTaskWrapper implements Parcelable {

    public static final Creator<IPI_EPSTaskWrapper> CREATOR = new Creator<IPI_EPSTaskWrapper>() {
        @Override
        public IPI_EPSTaskWrapper createFromParcel(Parcel in) {
            return new IPI_EPSTaskWrapper(in);
        }

        @Override
        public IPI_EPSTaskWrapper[] newArray(int size) {
            return new IPI_EPSTaskWrapper[size];
        }
    };
    ...
    // Empty constructor
    public IPI_EPSTaskWrapper() { }

    protected IPI_EPSTaskWrapper(Parcel in) {
        _id = in.readInt();
