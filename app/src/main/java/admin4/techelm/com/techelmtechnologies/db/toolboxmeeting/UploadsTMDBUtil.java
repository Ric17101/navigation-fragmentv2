...
public class UploadsTMDBUtil extends DatabaseAccess {
    ...
    /*public List<ServiceJobUploadsWrapper> getAllRecordings() {
        ...
        String selectQuery = "SELECT * FROM " + UploadsSJDBUtil.DBHelperItem.TABLE_NAME;
    ...
    /*public List<ServiceJobUploadsWrapper> getAllUploadsBySJID(int id) {
        ArrayList<ServiceJobUploadsWrapper> list = new ArrayList<>();
        String selectQuery = "SELECT * FROM " + UploadsSJDBUtil.DBHelperItem.TABLE_NAME
                + " WHERE "+ UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_SERVICE_ID +"=" + id;
        Cursor cursor = getDB().rawQuery(selectQuery, null);
    ...
    public void removeItemWithId(int id) {
        ...
        db.delete(UploadsSJDBUtil.DBHelperItem.TABLE_NAME,
                UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_ID + "=?", whereArgs);
    ...
    public int getCount() {
        SQLiteDatabase db = getDB();
        String[] projection = { UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_ID };
        Cursor c = db.query(UploadsSJDBUtil.DBHelperItem.TABLE_NAME, projection, null, null, null, null, null);
    ...
    /*public void renameItem(ServiceJobUploadsWrapper item, String recordingName, String filePath) {
        SQLiteDatabase db = getDB();
        ContentValues cv = new ContentValues();
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_NAME, recordingName);
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_FILE_PATH, filePath);
        db.update(UploadsSJDBUtil.DBHelperItem.TABLE_NAME, cv,
                UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_ID + "=" + item.getID(), null);
    ...
    /*public long restoreRecording(ServiceJobUploadsWrapper item) {
        SQLiteDatabase db = getDB();
        ContentValues cv = new ContentValues();
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_NAME, item.getUploadName());
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_FILE_PATH, item.getFilePath());
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_SERVICE_ID, item.getServiceId());
        cv.put(UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_ID, item.getID());
        long rowId = db.insert(UploadsSJDBUtil.DBHelperItem.TABLE_NAME, null, cv);
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onNewUploadsDBEntryAdded(item.getUploadName());
        }
        return rowId;
    ...
    /*public boolean hasInsertedRecordings(int servicejob_id) {
        String selectQuery = "SELECT * FROM " + UploadsSJDBUtil.DBHelperItem.TABLE_NAME
                + " WHERE "+ UploadsSJDBUtil.DBHelperItem.COLUMN_NAME_UPLOADS_SERVICE_ID + "=" + servicejob_id;
        Cursor cursor = getDB().rawQuery(selectQuery, null);
