...
public class PlaybackFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.m_service_report_media_playback, null);
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.colorAccent), getResources().getColor(R.color.colorBlueThemed));
