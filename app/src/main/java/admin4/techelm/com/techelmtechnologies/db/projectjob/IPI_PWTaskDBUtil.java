...
public class IPI_PWTaskDBUtil extends DatabaseAccess {

    private static final String LOG_TAG = "RecordingSJDBUtil";

    public static abstract class DBHelperItem implements BaseColumns {
        public static final String TABLE_NAME = "projectjob_ipi_pw_tasks";
        ...
        public static final String COLUMN_NAME_RECORDING_LENGTH = "status";
        public static final String COLUMN_NAME_RECORDING_TIME_ADDED = "non_conformance";
        public static final String COLUMN_NAME_RECORDING_TAKEN = "corrective_actions";
        public static final String COLUMN_NAME_RECORDING_TAKEN_ = "target_completion_date";
    }
     ...
     * @param context
     */
    public IPI_PWTaskDBUtil(Context context) {
        super(context);
        try {
     ...
     */
    public IPI_PWTaskDBUtil(Context context, String message) {
        super(context);
    ...
    public void renameItem(ServiceJobRecordingWrapper item, String recordingName, String filePath) {
        ...
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onIPI_PWTaskEntryRenamed(item.getRecordingName());
        }
    }
