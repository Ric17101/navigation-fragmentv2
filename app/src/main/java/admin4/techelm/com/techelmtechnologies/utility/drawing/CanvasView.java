...
package admin4.techelm.com.techelmtechnologies.utility.drawing;
...
public class CanvasView extends View {
    ...
    // for Eraser
    private int canvasBackgroundColor = Color.TRANSPARENT;
    private int canvasWhiteEraser = Color.WHITE;
    ...
    private Paint createPaint() {
        ...
        if (this.mode == Mode.ERASER) {
            paint.setColor(canvasWhiteEraser); // Eraser
        }
